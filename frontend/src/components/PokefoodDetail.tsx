                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        ...
                        <div className="rounded-xl bg-[var(--color-surface-container-high)] p-4">
                            ...
                            <div className="space-y-2">
                                <div
                                    className="flex items-center gap-2 text-xs text-[var(--color-on-surface-variant)] md:text-sm">
                                    ...
                                    <span>Calories: <span
                                        className="text-[var(--color-on-surface)]">{pokefood.nutritionInfo.calories}</span></span>
                                </div>
                                <div
                                    className="flex items-center gap-2 text-xs text-[var(--color-on-surface-variant)] md:text-sm">
                                    ...
                                    <span>Protein: <span
                                        className="text-[var(--color-on-surface)]">{pokefood.nutritionInfo.protein}g</span></span>
                                </div>
                                <div
                                    className="flex items-center gap-2 text-xs text-[var(--color-on-surface-variant)] md:text-sm">
                                    ...
                                    <span>Carbs: <span
                                        className="text-[var(--color-on-surface)]">{pokefood.nutritionInfo.carbs}g</span></span>
                                </div>
                                <div
                                    className="flex items-center gap-2 text-xs text-[var(--color-on-surface-variant)] md:text-sm">
                                    ...
                                    <span>Fat: <span
                                        className="text-[var(--color-on-surface)]">{pokefood.nutritionInfo.fat}g</span></span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        confirmingTransfer ? (
                            <div
                                ...
                                <p className="text-xs text-[var(--color-on-surface-variant)] md:text-sm">
                                    Transfer <span className="text-[var(--color-on-surface)]">{pokefood.name}</span>?
